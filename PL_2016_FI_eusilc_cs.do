...
* IGa
gen pl_ben = 24.64 * 21.7 			if country == "FI" & year == 2016 ///
									& pl_eli == 1 & (earning*12) < 10562

* IGb
replace pl_ben = earning * 0.7 		if country == "FI" & year == 2016 ///
									& pl_eli == 1 & pl_ben == . ///
									& inrange((earning*12),10562,37167)

* IGc 
gen pl_bena = (37168/12) * 0.7 		if country == "FI" & year == 2016 ///
...
replace pl_ben1 = pl_ben 		if country == "FI" & year == 2016 & pl_eli == 1
