...
replace ml_eli = 1 			if country == "NO" & year == 2014 & gender == 2 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6
...
* both partners are eligible
replace ml_dur2 = 15-3 		if country == "NO" & year == 2014 & ml_eli == 1 & gender == 1 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) >= 6

* only man is eligible
replace ml_dur2 = 6 		if country == "NO" & year == 2014 & gender == 2 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6

* single man
replace ml_dur2 = 12		if country == "NO" & year == 2014 & gender == 2 ///
							& (duremp + dursemp) >= 6  & parstat == 1
...
replace ml_ben1 = 59685/12			if country == "NO" & year == 2014 & ml_eli == 1 ///
								& ml_ben1 >= 59685/12
replace ml_ben1 = 4943/11			if country == "NO" & year == 2014 & ml_eli == 1 ///
								& ml_ben1 < 4943/11
