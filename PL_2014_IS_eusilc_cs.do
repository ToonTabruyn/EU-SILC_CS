...
replace pl_ben1 = 682	 				if country == "IS" & year == 2014 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pl_ben1 < 682 & gender == 1
										
replace pl_ben1 = 2504	 				if country == "IS" & year == 2014 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
...
replace pl_ben1 = 945	 				if country == "IS" & year == 2014 & pl_eli == 1 ///
...
* the rest - women
replace pl_ben1 = 412					if country == "IS" & year == 2014 & pl_eli == 1 ///
