...
replace pt_eli = 0 if pt_eli == . & country == "FI" & year == 2018


* DURATION (weeks)
/* -> 54 days */ 
replace pt_dur = 54/6 if country == "FI" & year == 2018 & pt_eli == 1 // MISSOC 01/07/2018
...
gen pt_benb = (((earning*12) - 37168) / 12) * 0.4 		if country == "FI" ///
									& year == 2018	& gender == 1 & pt_eli == 2 ///
...
* IGd	
gen pt_benc = ((57183-37168) / 12) * 0.4			if country == "FI" ///
													& year == 2018	& gender == 2 ///
													& pt_eli == 1 & (earning*12) > 57183
	
gen pt_bend = (((earning*12) - 57183) / 12) * 0.25 		if country == "FI" ///
									& year == 2019	& gender == 2 & pt_eli == 1 ///
									& (earning*12) > 57183
			

replace pt_ben = pt_bena + pt_benc + pt_bend 		if country == "FI" ///
							& year == 2018	& gender == 2 & pt_eli == 1 & pt_eli == . ///
							& (earning*12) > 57183
