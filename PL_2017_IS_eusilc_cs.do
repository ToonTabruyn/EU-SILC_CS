...
replace pl_ben1 = 1007	 				if country == "IS" & year == 2018 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pl_ben1 < 1007 & gender == 1
										
replace pl_ben1 = 4257	 				if country == "IS" & year == 2018 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
...
replace pl_ben1 = 1396	 				if country == "IS" & year == 2018 & pl_eli == 1 ///
...
* the rest - women
replace pl_ben1 = 609					if country == "IS" & year == 2018 & pl_eli == 1 ///
