...
/*	-> employed, self-employed compulsorily insured for at least 365 days (coded)
		...
		-> for 2 years: 70% earning, ceiling: €700/month (MISSOC 2014; GYED)
...
* GYES
gen pl_gyes = 90 		if country == "HU" & year == 2014 & pl_eli == 1
...
replace pl_gyed = 700		 	if country == "HU" & year == 2014 & pl_eli == 1 ///
								& ml_eli == 1 & inlist(econ_status,1,2) ///
								& earning >= 700 & gender == 1
