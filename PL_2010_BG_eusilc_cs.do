...
* ELIGIBILITY
/* 	-> Parental leave is specifically designed for women (LP&R 2010)
...
replace pl_dur = (2*52) - ml_dur2 		if country == "BG" & year == 2010 & pl_eli == 1 ///
										...
										& ml_eli == 1
replace pl_dur = 52 		if country == "BG" & year == 2010 & pl_eli == 1 ///
...
replace pl_ben1 = 174	 if country == "BG" & year == 2010 & pl_eli == 1 ///
						 & gender == 1 & econ_status == 1 & duremp >= 12
replace pl_ben1 = 51	 if country == "BG" & year == 2010 & pl_eli == 1 ///
