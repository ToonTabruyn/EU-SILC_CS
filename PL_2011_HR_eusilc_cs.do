...
replace pl_dur = 4 		if country == "HR" & year == 2011 & pl_eli == 1 ///
						& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 
						
						
replace pl_dur = 6 		if country == "HR" & year == 2011 & pl_eli == 1 ///
						& pl_dur == . 
...
replace pl_ben1 = 565 	if country == "HR" & year == 2011 & pl_eli == 1 ///
						& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 & earning > 565


replace pl_ben1 = 225.22 	if country == "HR" & year == 2011 & pl_eli == 1 ///
						& pl_ben1 == . 
