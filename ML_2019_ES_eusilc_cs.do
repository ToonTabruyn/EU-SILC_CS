...
replace ml_eli = 1 			if country == "ES" & year == 2019 & gender == 1 ///
							& inlist(econ_status,1,2) 

* single men							
replace ml_eli = 1 		if country == "ES" & year == 2019 & gender == 2 ///
							& inlist(econ_status,1,2) & parstat == 1
														
													
replace ml_eli = 0 			if ml_eli == . & country == "ES" & year == 2019 & gender == 1
...
replace ml_dur1 = 0 		if country == "ES" & year == 2019 & ml_eli == 1
...
replace ml_dur2 = 42/5		if country == "ES" & year == 2019 & ml_eli == 1 ///
							& ml_dur2 == .
...
* BENEFIT (monthly)
/*	-> employed, self-employed who didn't fulfill the contribution requirements: €537.84/month (LP&R 2019)
...
replace ml_ben1 = 4070.10 		if country == "ES" & year == 2019 & ml_eli == 1 ///
								& ml_ben1 >= 4070.10

replace ml_ben1 = 537.84		if country == "ES" & year == 2019 & ml_eli == 1 ///
								& ml_ben1 == .


replace ml_ben2 = ml_ben1 		if country == "ES" & year == 2019 & ml_eli == 1


foreach x in 1 2 {
	replace ml_dur`x' = 0 	if country == "ES" & year == 2019 & ml_eli == 0
	replace ml_ben`x' = 0 	if country == "ES" & year == 2019 & ml_eli == 0
