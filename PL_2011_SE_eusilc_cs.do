...
replace pl_dur = 150/7 		if country == "SE" & year == 2011 & pl_eli == 1 

	* single 
replace pl_dur = (150+150)/7	if country == "SE" & year == 2011 & parstat == 1
...
* all others									
replace pl_ben1 = 27*30				if country == "SE" & year == 2011 & pl_eli == 1 ///
									& earning == 0 & pl_dur != . 
									

								
replace pl_ben2 = 0.776*earning		if country == "SE" & year == 2011 & pl_eli == 1 ///
									& earning/30 >= 26 & pl_dur != .
									
replace pl_ben2 = 46972/12			if country == "SE" & year == 2011 & pl_eli == 1 ///
									& earning*12 >= 46972 & pl_dur != .
									
replace pl_ben2 = 27*30				if country == "SE" & year == 2011 & pl_eli == 1 ///
									& earning == 0 & pl_dur != . 
