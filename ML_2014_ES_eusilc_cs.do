...
replace ml_eli = 1 			if country == "ES" & year == 2014 & gender == 1 ///
							& inlist(econ_status,1,2) 

* single men							
replace ml_eli = 1 			if country == "ES" & year == 2014 & gender == 2 ///
							& inlist(econ_status,1,2) & parstat == 1
														
													
replace ml_eli = 0 			if ml_eli == . & country == "ES" & year == 2014 & gender == 1
...
replace ml_dur1 = 0 		if country == "ES" & year == 2014 & ml_eli == 1

replace ml_dur2 = 16 		if country == "ES" & year == 2014 & ml_eli == 1 ///
...
replace ml_dur2 = 42/5		if country == "ES" & year == 2014 & ml_eli == 1 ///
							& ml_dur2 == .

* single men
replace ml_dur2 = 10 		if country == "ES" & year == 2014 &  ml_eli == 1 ///
							& gender == 2 & parstat == 1
...
replace ml_ben2 = ml_ben1 		if country == "ES" & year == 2014 & ml_eli == 1


foreach x in 1 2 {
	replace ml_dur`x' = 0 	if country == "ES" & year == 2014 & ml_eli == 0
	replace ml_ben`x' = 0 	if country == "ES" & year == 2014 & ml_eli == 0
