...
replace pt_eli = 1 		if country == "IS" & year == 2012 & gender == 2 

* single women
replace pt_eli = 1 		if country == "IS" & year == 2012 & gender == 1 ///
						& parstat == 1
replace pt_eli = 0 		if pt_eli == . & country == "IS" & year == 2012 & gender == 2
...
replace pt_dur = 3*4.3 	if country == "IS" & year == 2012 & pt_eli == 1 
...
/*	-> employed, self-employed: active for 6 months prior to birth
			...
			- 80% earning until €1270 per month, and 75% earning of remuneration beyond €1270/month
			- ceiling: €1,905/month 
...
replace pt_ben1 = 0.8*earning	 		if country == "IS" & year == 2012 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) & earning < 1270

replace pt_ben1 = (0.8 * 1270) + (0.75 * (earning-1270)) 	if country == "IS" & year == 2012 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) & earning >= 1270	

replace pt_ben1 = 584	 				if country == "IS" & year == 2012 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pt_ben1 < 584
										
replace pt_ben1 = 1905	 				if country == "IS" & year == 2012 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pt_ben1 >= 1905
...
replace pt_ben1 = 809	 				if country == "IS" & year == 2012 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& pt_ben1 < 809
...
* the rest 
replace pt_ben1 = 353					if country == "IS" & year == 2012 & pt_eli == 1 ///
...
replace pt_ben2 = pt_ben1 	if country == "IS" & year == 2012 & pt_eli == 1



foreach x in 1 2 {
	replace pt_ben`x' = 0 	if country == "IS" & year == 2012 & pt_eli == 0
}

replace pt_dur = 0 		if country == "IS" & year == 2012 & pt_eli == 0 
