...
*/
replace pt_dur = (2/5) + 4 		if country == "ES" & year == 2012 & pt_eli == 1 ///
								& econ_status == 1

replace pt_dur = 4 				if country == "ES" & year == 2012 & pt_eli == 1 ///
								& econ_status == 2
...
replace pt_ben1 = 3803 		if country == "ES" & year == 2012 & pt_eli == 1 ///
							& pt_ben1 > 3803.7
