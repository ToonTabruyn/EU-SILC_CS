...
/*	-> 100% earning, no ceiling
		- women may choose between 100% and 80% (LP&R 2010)
...
replace ml_ben1 = earning*0.8 		if country == "PL" & year == 2010 & ml_eli == 1
replace ml_ben1 = 226 				if country == "PL" & year == 2010 & ml_eli == 1 ///
									& ml_ben1 < 226
