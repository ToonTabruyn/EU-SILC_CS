...
gen p_dab1 = 38 							if country == "CZ" & year == 2016 ///
											& inrange(p_earning/21.7,38,58) & parstat == 2 ///
											& econ_status != 1 & p_econ_status == 1
											
gen p_dab2 = ((p_earning/21.7) - 38)*0.6 	if country == "CZ" & year == 2016 ///
											& inrange(p_earning/21.7,38,58) & parstat == 2 ///
											& econ_status != 1 & p_econ_status == 1
...
gen p_dab2 = (58 - 38)*0.6 				if country == "CZ" & year == 2016 ///
										& inrange(p_earning/21.7,58,115) ///
										& parstat == 2 & econ_status != 1 & p_econ_status == 1
										
gen p_dab3 = ((p_earning/21.7) - 58)*0.3 	if country == "CZ" & year == 2016 ///
...
gen p_dab3 = (115 - 58)*0.3			 	if country == "CZ" & year == 2016 ///
										& p_earning/21.7 > 115  & parstat == 2 ///
										& econ_status != 1 & p_econ_status == 1
...
replace pl_dur = (8461/((0.7 * p_dab)*21.7)) * 4.3 	if country == "CZ" & year == 2016 & pl_eli == 1 /// 
