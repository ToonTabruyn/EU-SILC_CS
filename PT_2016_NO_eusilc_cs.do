...
replace pt_dur = 15 		if country == "NO" & year == 2016 & pt_eli == 1 & gender == 2 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6
replace pt_dur = 15 		if country == "NO" & year == 2016 & gender == 2 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) >= 6

* only woman is eligible 
replace pt_dur = 15 		if country == "NO" & year == 2016 & pt_eli == 1 & gender == 1 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6
...
replace pt_ben1 = 5113			if country == "NO" & year == 2016 & pt_eli == 1 ///
								& pt_ben1 >= 5113
replace pt_ben1 = 605			if country == "NO" & year == 2016 & pt_eli == 1 ///
								& pt_ben1 < 605
