...
replace ml_dur2 = 90/7 		if country == "SE" & year == 2014 & ml_eli == 1
...
/*	-> eligible for earning related benefit: min. income €27/day (coded) for 240 calendar days (not coded) before childbirth
		- for 195 calendar days (includes 90 non-transferable leave): 77.6% earning
			- minimum: €27/day
			- ceiling: €46,972/month - this is an earning ceiling NOT benefit ceiling (LP&R 2014)
...
replace ml_ben1 = 0.776*earning 		if country == "SE" & year == 2014 & ml_eli == 1 ///
										& (earning/30) >= 26
replace ml_ben1 = 27*30					if country == "SE" & year == 2014 & ml_eli == 1 ///
										& ml_ben1 < 27*30
replace ml_ben1 = 0.776*46972			if country == "SE" & year == 2014 & ml_eli == 1 ///
										& earning >= 46972
