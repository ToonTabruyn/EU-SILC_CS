...
replace ml_eli = 1 			if country == "NO" & year == 2012 & gender == 2 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6
...
* only man is eligible
replace ml_dur2 = 6 		if country == "NO" & year == 2012 & gender == 2 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6

* single man
replace ml_dur2 = 12		if country == "NO" & year == 2012 & gender == 2 ///
							& (duremp + dursemp) >= 6  & parstat == 1
