...
replace pl_ben1 = . 	if country == "LU" & year == 2018 & pl_eli == 1
replace pl_ben2 = .		if country == "LU" & year == 2018 & pl_eli == 1


foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "LU" & year == 2018
}

replace pl_dur = 0 	if pl_eli == 0 & country == "LU" & year == 2018
