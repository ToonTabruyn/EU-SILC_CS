...
replace pl_eli = 1 			if country == "PL" & year == 2010 
replace pl_eli = 0			if pl_eli == . & country == "PL" & year == 2010
...
replace pl_dur = 32 		if country == "PL" & year == 2010 & pl_eli == 1 ///
							& gender == 1 & econ_status == 1
replace pl_dur = 52 		if country == "PL" & year == 2010 & pl_eli == 1 ///
...
replace pl_ben1 = earning*0.8 		if country == "PL" & year == 2010 & pl_eli == 1 ///
									& econ_status == 1 & pl_dur != .
replace pl_ben1 = 229				if country == "PL" & year == 2010 & pl_eli == 1 ///
									& inrange(econ_status,2,4) & pl_dur != .
									
replace pl_ben2 = pl_ben1			if country == "PL" & year == 2010 & pl_eli == 1
...
replace pl_dur = 0 	if pl_eli == 0 & country == "PL" & year == 2010
