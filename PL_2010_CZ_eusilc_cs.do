...
/* daily assessment base (source: MISSOC 2010, IV. Maternity/Paternity):
...
* daily earning < 33
gen p_dab = p_earning/21.7 				if country == "CZ" & year == 2010 ///
										& (p_earning/21.7) < 33 & parstat == 2 ///
										& econ_status != 1 & p_econ_status == 1

* daily earning between €33 and €50
gen p_dab1 = 33 							if country == "CZ" & year == 2010 ///
											& inrange(p_earning/21.7,33,50) & parstat == 2 ///
											& econ_status != 1 & p_econ_status == 1
											
gen p_dab2 = ((p_earning/21.7) - 33)*0.6 	if country == "CZ" & year == 2010 ///
											& inrange(p_earning/21.7,33,50) & parstat == 2 ///
											& econ_status != 1 & p_econ_status == 1
											 
replace p_dab = p_dab1 + p_dab2 			if country == "CZ" & year == 2010 ///
...
gen p_dab2 = (50 - 33)*0.6 				if country == "CZ" & year == 2010 ///
										& inrange(p_earning/21.7,50,100) ///
										& parstat == 2 & econ_status != 1 & p_econ_status == 1
										
gen p_dab3 = ((p_earning/21.7) - 50)*0.3 	if country == "CZ" & year == 2010 ///
											& inrange(p_earning/21.7,50,100) & parstat == 2 ///
											& econ_status != 1 & p_econ_status == 1

										
replace p_dab = p_dab1 + p_dab2 + p_dab3  		if country == "CZ" & year == 2010 ///
												& inrange(p_earning/21.7,50,100)  ///
...
gen p_dab3 = (100 - 50)*0.3			 	if country == "CZ" & year == 2010 ///
										& p_earning/21.7 > 100  & parstat == 2 ///
										& econ_status != 1 & p_econ_status == 1
...
replace pl_dur = 4*52		if country == "CZ" & year == 2010 & pl_eli == 1 ///
										& econ_status != 1 & parstat == 1

	* employed
replace pl_dur = (8114 / ((0.7*dab)*21.7)) * 4.3 		if country == "CZ" & year == 2010 & pl_eli == 1 ///
														& econ_status == 1 & parstat == 1 & pl_dur == . ///
														& earning < 424
	* employed, above ceiling	
replace pl_dur = (8114 / 424) * 4.3 					if country == "CZ" & year == 2010 & pl_eli == 1 ///
														& econ_status == 1 & parstat == 1 & pl_dur == . ///
														& earning >= 424
...
replace pl_dur = (8114/((0.7 * p_dab)*21.7)) * 4.3 	if country == "CZ" & year == 2010 & pl_eli == 1 /// 
...
* SINGLE
	* not employed
replace pl_ben1 = (292 * (10/58)) + (140 * (48/58)) 					if country == "CZ" & year == 2010 & pl_eli == 1 ///
										& econ_status != 1 & parstat == 1
										
	* employed, below ceiling
replace pl_ben1 = 0.7 * (21.7*dab)		if country == "CZ" & year == 2010 & pl_eli == 1 ///
										& econ_status == 1 & parstat == 1 
										
	* employed, above ceiling
replace pl_ben1 = 424					if country == "CZ" & year == 2010 & pl_eli == 1 ///
...
replace pl_ben1 =  0.7 * (21.7*p_dab)	if country == "CZ" & year == 2010 & pl_eli == 1 ///
