...
replace pt_dur = 15 		if country == "NO" & year == 2010 & pt_eli == 1 
...
* ceiling
replace pt_ben1 = 59685/12			if country == "NO" & year == 2010 & pt_eli == 1 ///
									& pt_ben1 >= 59685/12

* minimum
replace pt_ben1 = 4943/11			if country == "NO" & year == 2010 & pt_eli == 1 ///
									& pt_ben1 < 4943/11
