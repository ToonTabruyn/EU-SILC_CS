...
replace pt_eli = 0 		if pt_eli == . & country == "GB" & year == 2018 & gender == 2


* DURATION (weeks)
/*	-> father can choose between 1 or 2 weeks (coded) */

replace pt_dur = 2 	if country == "GB" & year == 2018 & pt_eli == 1
...
replace pt_ben2 = pt_ben1 	if country == "GB" & year == 2018 & pt_eli == 1



foreach x in 1 2 {
	replace pt_ben`x' = 0 	if country == "GB" & year == 2018 & pt_eli == 0
}
