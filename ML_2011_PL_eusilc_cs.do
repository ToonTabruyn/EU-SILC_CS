...
replace ml_dur2 = 20 		if country == "PL" & year == 2011 & ml_eli == 1


* BENEFIT (monthly)
/*	-> 100% earning, no ceiling
		- women may choose between 100% and 80% (LP&R 2011)
...
replace ml_ben1 = earning*0.8 		if country == "PL" & year == 2011 & ml_eli == 1
replace ml_ben1 = 226 				if country == "PL" & year == 2011 & ml_eli == 1 ///
									& ml_ben1 < 226
