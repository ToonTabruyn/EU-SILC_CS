...
*/
	...
	* women
replace pl_dur = 19 		if country == "NO" & year == 2015 & pl_eli == 1 & gender == 1

	* single men
replace pl_dur = 19 		if country == "NO" & year == 2015 & pl_eli == 1 & gender == 2 & parstat == 1
...
replace pl_ben1 = 59685/12		if country == "NO" & year == 2015 & pl_eli == 1 ///
								& pl_ben1 >= 59685/12 & gender == 1
replace pl_ben1 = 4943/11		if country == "NO" & year == 2015 & pl_eli == 1 ///
