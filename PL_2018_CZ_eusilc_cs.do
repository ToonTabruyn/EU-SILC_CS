...
* daily earning < €38
gen dab = earning/21.7 				if country == "CZ" & year == 2018 & pl_eli == 1 ///
									& earning/21.7 < 38

* daily earning between €38 and €58
gen dab1 = 38 							if country == "CZ" & year == 2018 & pl_eli == 1 ///
									& 	inrange(earning/21.7,38,57)
gen dab2 = ((earning/21.7) - 38)*0.6 	if country == "CZ" & year == 2018 & pl_eli == 1 ///
										& inrange(earning/21.7,38,57)
replace dab = dab1 + dab2 				if country == "CZ" & year == 2018 & pl_eli == 1 ///
...
gen dab2 = (58 - 38)*0.6 			if country == "CZ" & year == 2018 & pl_eli == 1 ///
									& inrange(earning/21.7,58,115)
gen dab3 = ((earning/21.7) - 58)*0.3 	if country == "CZ" & year == 2018 & pl_eli == 1 ///
										& inrange(earning/21.7,58,115)

replace dab = dab1 + dab2 + dab3  	if country == "CZ" & year == 2018 & pl_eli == 1 ///
...
gen dab3 = (115 - 58)*0.3 			if country == "CZ" & year == 2018 & pl_eli == 1 ///
									& earning/21.7 > 115
