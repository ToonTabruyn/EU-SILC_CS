...
replace pl_ben1 = 66 * 21.7			if country == "AT" & year == 2015 & pl_eli == 1 /// 
									& econ_status == 1 & parstat == 1 ///
									& pl_ben1 >= (66*21.7)								
 
 ** not employed & single
replace pl_ben1 = 33.88 * 21.7	 	if country == "AT" & year == 2015 & pl_eli == 1 /// 
...
replace pl_ben1 = 0.8 * p_earning	if country == "AT" & year == 2015 & pl_eli == 1 ///
