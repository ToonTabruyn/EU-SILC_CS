...
replace pl_ben1 = 0.6* earning 		if country == "LV" & year == 2013 & pl_eli == 1 ///
									& inlist(econ_status,1,2) & gender == 1

* women, unemployed or inactive									
replace pl_ben1 = (171*(18/24)) + (42.69*(6/24)) 	if country == "LV" & year == 2013 & pl_eli == 1 ///
													& inlist(econ_status,3,4) & gender == 1	
...
replace pl_ben2 = (171*(18/24))		if country == "LV" & year == 2013 & pl_eli == 1 ///
