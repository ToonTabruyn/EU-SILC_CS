...
replace ml_ben1 = 799	 				if country == "IS" & year == 2012 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& ml_ben1 < 799
										
replace ml_ben1 = 2677	 				if country == "IS" & year == 2012 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& ml_ben1 >= 2677
...
replace ml_ben1 = 1108	 				if country == "IS" & year == 2012 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& ml_ben1 < 1108
...
* the rest 
replace ml_ben1 = 483					if country == "IS" & year == 2012 & ml_eli == 1 ///
