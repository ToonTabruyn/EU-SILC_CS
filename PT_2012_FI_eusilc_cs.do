...
* DURATION (weeks)
/* -> 54 days */ 
replace pt_dur = 54/6 if country == "FI" & year == 2012 & pt_eli == 1 
...
* IGa
replace pt_ben1 = 23.93 * 21.7 			if country == "FI" & year == 2012 & gender == 2 ///
									& pt_eli == 1 
...
* IGc 
gen pt_bena = (36687/12) * 0.7 		if country == "FI" & year == 2012 & gender == 2 ///
