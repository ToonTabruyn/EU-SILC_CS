...
* WOMEN 
* IGa
replace pl_ben1 = 23.93 * 21.7 			if country == "FI" & year == 2010 & gender == 1 ///
										& pl_eli == 1 
...
* IGc 
gen pl_bena = (36687/12) * 0.7 		if country == "FI" & year == 2010 & gender == 1 ///
...
gen pl_benc = (56443/12) * 0.4			if country == "FI" & year == 2010	& gender == 1 ///
...
* SINGLE MEN
* IGa
replace pl_ben1 = 23.93 * 21.7 			if country == "FI" & year == 2010 & gender == 2 ///
										& pl_eli == 1 & parstat == 1
...
* IGc 
replace pl_bena = (36687/12) * 0.7 		if country == "FI" & year == 2010 & gender == 2 ///
...
replace pl_benc = (56443/12) * 0.4		if country == "FI" & year == 2010	& gender == 2 ///
