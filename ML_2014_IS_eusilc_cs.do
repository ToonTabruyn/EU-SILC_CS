...
replace ml_eli = 1 			if country == "IS" & year == 2014 & gender == 1

* single men
replace ml_eli = 1 			if country == "IS" & year == 2014 & gender == 2 ///
							& parstat == 1

replace ml_eli = 0 			if ml_eli == . & country == "IS" & year == 2014 & gender == 1
...
*/
replace ml_dur1 = 0	 			if country == "IS" & year == 2014 & ml_eli == 1 

replace ml_dur2 = 3*4.3 		if country == "IS" & year == 2014 & ml_eli == 1 
...
replace ml_ben1 = 0.8*earning	 		if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19)

replace ml_ben1 = 799	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& ml_ben1 < 799
										
replace ml_ben1 = 2677	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& ml_ben1 >= 2677
...
replace ml_ben1 = 1108	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& ml_ben1 < 1108
...
* the rest 
replace ml_ben1 = 483					if country == "IS" & year == 2014 & ml_eli == 1 ///
...
replace ml_ben2 = ml_ben1 		if country == "IS" & year == 2014 & ml_eli == 1


foreach x in 1 2 {
	replace ml_dur`x' = 0 	if country == "IS" & year == 2014 & ml_eli == 0
	replace ml_ben`x' = 0 	if country == "IS" & year == 2014 & ml_eli == 0
