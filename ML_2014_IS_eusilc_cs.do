...
replace ml_ben1 = 682	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& ml_ben1 < 682
										
replace ml_ben1 = 2504	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& ml_ben1 >= 2504
...
replace ml_ben1 = 945	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& ml_ben1 < 945
...
* the rest 
replace ml_ben1 = 412					if country == "IS" & year == 2014 & ml_eli == 1 ///
