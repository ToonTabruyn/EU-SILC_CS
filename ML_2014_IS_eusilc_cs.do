...
replace ml_ben1 = 631	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& ml_ben1 < 631
										
replace ml_ben1 = 2389	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& ml_ben1 >= 2389
...
replace ml_ben1 = 875	 				if country == "IS" & year == 2014 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& ml_ben1 < 875
...
* the rest 
replace ml_ben1 = 382					if country == "IS" & year == 2014 & ml_eli == 1 ///
