...
/*	-> 10 days: 77.6% earning
	...
	-> 90 days: 77.6% earning
			- minimum: E 26/day
			- ceiling: E 46,803/month - this is an earning ceiling NOT benefit ceiling (LP&R 2016)
*/
...
replace pt_ben1 = 26*30					if country == "SE" & year == 2016 & ml_eli == 1 ///
										& (earning/30) < 26

replace pt_ben1 = [(0.776*35103) * (10/(90+10))] + [(0.776*earning) * (90/(90+10))] ///
										if country == "SE" & year == 2016 & ml_eli == 1 ///
...
replace pt_ben2 = 26*30					if country == "SE" & year == 2016 & ml_eli == 1 ///
										& (earning/30) < 26
