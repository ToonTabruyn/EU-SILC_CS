...
/*	-> 10 days: 77.6% earning
	...
	-> 90 days: 77.6% earning
			- minimum: €26/day
			- ceiling: €46,803/year - this is an earning ceiling NOT benefit ceiling (LP&R 2016)
*/
...
replace pt_ben1 = 26 * 21.7				if country == "SE" & year == 2016 & pt_eli == 1 ///
										& (earning/21.7) < 26
...
replace pt_ben2 = 26*21.7				if country == "SE" & year == 2016 & pt_eli == 1 ///
										& (earning/21.7) < 26
