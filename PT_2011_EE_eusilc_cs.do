...
* ELIGIBILITY
/*	-> employed (coded) fathers with permanent contract (MISSOC 01/07/2011; not coded) */ 
...
* BENEFIT (monthly)
/*	-> 100% of earning
	-> ceiling: 3x the average gross monthly salary (MISSOC 2011)
	-> average gross monthly salary, 2011: €1,310 (Source: Statistics Estonia, 
...
replace pt_ben1 = earning 	if country == "EE" & year == 2011 & pt_eli == 1
							
							
replace pt_ben1 = ((3*1310) * (pt_dur/4.3)) + (earning * ((4.3-pt_dur)/4.3)) ///
							if country == "EE" & year == 2011 & pt_eli == 1 ///
							& pt_ben1 >= 3*1310
