...
replace pt_ben1 = 682	 				if country == "IS" & year == 2015 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pt_ben1 < 682
										
replace pt_ben1 = 2504	 				if country == "IS" & year == 2015 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pt_ben1 >= 2504
...
replace pt_ben1 = 945	 				if country == "IS" & year == 2015 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& pt_ben1 < 945
...
* the rest 
replace pt_ben1 = 412					if country == "IS" & year == 2015 & pt_eli == 1 ///
