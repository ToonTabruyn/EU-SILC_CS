...
replace ml_dur1 = 2 		if country == "FR" & year == 2013 & gender == 1 & ml_eli == 1

replace ml_dur2 = 16-2 		if country == "FR" & year == 2013 & gender == 1 ///
							& ml_eli == 1 & childc < 2
							
replace ml_dur2 = 26-2 		if country == "FR" & year == 2013 & gender == 1 ///
							& ml_eli == 1 & childc >= 2
