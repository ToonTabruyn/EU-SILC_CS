...
replace ml_eli = 1 			if country == "SK" & year == 2010 & gender == 1 /// 
							& inlist(econ_status,1,2) & (duremp+dursemp) >= (270/7)/4.3


* single men
replace ml_eli = 1 			if country == "SK" & year == 2010 & gender == 2 /// 
							& inlist(econ_status,1,2) & (duremp+dursemp) >= (270/7)/4.3 & parstat == 1

							
replace ml_eli = 0 			if ml_eli == . & country == "SK" & year == 2010 & gender == 1
...
* single men
replace ml_dur2 = 31		if country == "SK" & year == 2010 & ml_eli == 1 ///
							& gender == 2 & parstat == 1
...
replace ml_ben2 = ml_ben1 		if country == "SK" & year == 2010 & ml_eli == 1


foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "SK" & year == 2010
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "SK" & year == 2010
}
