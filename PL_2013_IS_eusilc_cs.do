...
replace pl_ben1 = 799	 				if country == "IS" & year == 2013 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pl_ben1 < 799 & gender == 1
										
replace pl_ben1 = 2677	 				if country == "IS" & year == 2013 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
...
replace pl_ben1 = 1108	 				if country == "IS" & year == 2013 & pl_eli == 1 ///
...
* the rest - women
replace pl_ben1 = 483					if country == "IS" & year == 2013 & pl_eli == 1 ///
