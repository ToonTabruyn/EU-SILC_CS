...
* both partners are eligible
replace ml_dur2 = 12 		if country == "NO" & year == 2016 & ml_eli == 1 & gender == 1 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) >= 6
...
replace ml_ben1 = 5113			if country == "NO" & year == 2016 & ml_eli == 1 ///
								& ml_ben1 >= 5113
replace ml_ben1 = 605			if country == "NO" & year == 2016 & ml_eli == 1 ///
								& ml_ben1 < 605
