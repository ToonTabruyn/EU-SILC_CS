...
* ceiling
replace pt_ben1 = 59685/12			if country == "NO" & year == 2014 & pt_eli == 1 ///
									& pt_ben1 >= 59685/12

* minimum
replace pt_ben1 = 4943/11			if country == "NO" & year == 2014 & pt_eli == 1 ///
									& pt_ben1 < 4943/11


replace pt_ben2 = ml_ben1 		if country == "NO" & year == 2014 & pt_eli == 1
