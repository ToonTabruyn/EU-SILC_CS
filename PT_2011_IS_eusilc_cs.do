...
replace pt_eli = 1 		if country == "IS" & year == 2011 & gender == 2 

* single women
replace pt_eli = 1 		if country == "IS" & year == 2011 & gender == 1 ///
						& parstat == 1
replace pt_eli = 0 		if pt_eli == . & country == "IS" & year == 2011 & gender == 2
...
replace pt_dur = 3*4.3 	if country == "IS" & year == 2011 & pt_eli == 1 
...
replace pt_ben2 = pt_ben1 	if country == "IS" & year == 2011 & pt_eli == 1



foreach x in 1 2 {
	replace pt_ben`x' = 0 	if country == "IS" & year == 2011 & pt_eli == 0
}

replace pt_dur = 0 		if country == "IS" & year == 2011 & pt_eli == 0 
