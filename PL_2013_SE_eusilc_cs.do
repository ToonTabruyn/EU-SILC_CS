...
* all others									
replace pl_ben1 = 27*30				if country == "SE" & year == 2013 & pl_eli == 1 ///
									& earning == 0 & pl_dur != . 
...
replace pl_ben2 = 46972/12			if country == "SE" & year == 2013 & pl_eli == 1 ///
									& earning*12 >= 46972 & pl_dur != .
									
replace pl_ben2 = 27*30				if country == "SE" & year == 2013 & pl_eli == 1 ///
									& earning == 0 & pl_dur != . 
