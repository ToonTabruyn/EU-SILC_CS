...
/*	-> employed, self-employed compulsorily insured for at least 365 days (coded)
		...
		-> for 2 years: 70% earning, ceiling: €476/month (MISSOC 2015; GYED)
...
* GYES
gen pl_gyes = 92		if country == "HU" & year == 2015 & pl_eli == 1
...
gen pl_gyed = 0.7*earning 		if country == "HU" & year == 2015 & pl_eli == 1 ///
								...
								& earning < 476 & gender == 1
							
replace pl_gyed = 476		 	if country == "HU" & year == 2015 & pl_eli == 1 ///
								& ml_eli == 1 & inlist(econ_status,1,2) ///
								& earning >= 476 & gender == 1
								
	* single men
replace pl_gyed = 0.7*earning 	if country == "HU" & year == 2015 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & earning < 476 ///
								& gender == 2 & parstat == 1
