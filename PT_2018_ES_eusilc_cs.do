...
replace pt_eli = 1 		if country == "ES" & year == 2018 & gender == 2 ///
						& inlist(econ_status,1,2) & (duremp+dursemp) >= 180/21.7
						
replace pt_eli = 0 		if pt_eli == . & country == "ES" & year == 2018 & gender == 2
...
*/
replace pt_dur = (2/5) + 4 		if country == "ES" & year == 2018 & pt_eli == 1 ///
								& econ_status == 1

replace pt_dur = 4 				if country == "ES" & year == 2018 & pt_eli == 1 ///
								& econ_status == 2
...
foreach x in 1 2 {
	replace pt_ben`x' = 0 	if country == "ES" & year == 2018 & pt_eli == 0
}

replace pt_dur = 0 		if country == "ES" & year == 2018 & pt_eli == 0 
