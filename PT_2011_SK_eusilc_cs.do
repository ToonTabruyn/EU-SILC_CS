...
replace pt_eli = 1 		if country == "SK" & year == 2011 & gender == 2 ///
						& inlist(econ_status,1,2) & (duremp+dursemp) >= 270/30 & parstat == 2
		
						
replace pt_eli = 0 		if pt_eli == . & country == "SK" & year == 2011 & gender == 2
...
replace pt_dur = 28 	if country == "SK" & year == 2011 & pt_eli == 1 
...
replace pt_ben1 = 0.70*earning 		if country == "SK" & year == 2011 & pt_eli == 1
replace pt_ben1 = 1.5*889		 		if country == "SK" & year == 2011 & pt_eli == 1 ///
									& pt_ben1 >= 1.5*889


replace pt_ben2 = pt_ben1 	if country == "SK" & year == 2011 & pt_eli == 1

foreach x in 1 2 {
	replace pt_ben`x' = 0 	if pt_eli == 0 & country == "SK" & year == 2011
}

replace pt_dur = 0 if pt_eli == 0 & country == "SK" & year == 2011
