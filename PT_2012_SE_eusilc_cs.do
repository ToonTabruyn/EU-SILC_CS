...
replace pt_dur = (90/7) + (10/7)		 	if country == "SE" & year == 2012 & pt_eli == 1
...
/*	-> 10 days: 77.6% earning
	...
	-> 90 days: 77.6% earning
			- minimum: €27/day
			- ceiling: €46,972/year - this is an earning ceiling NOT benefit ceiling (LP&R 2012)
*/
...
replace pt_ben1 = 27 * 21.7				if country == "SE" & year == 2012 & pt_eli == 1 ///
										& (earning/21.7) < 27
...
replace pt_ben2 = 27*21.7				if country == "SE" & year == 2012 & pt_eli == 1 ///
										& (earning/21.7) < 27
