...
replace ml_ben1 = 203.85 * 21.7 	if country == "NL" & year == 2010 & gender == 1 ///
									& ml_eli == 1 & econ_status == 1 & ml_ben1 > 203.85 * 21.7

/*	-> self-employed: 100% of the net trading income
	-> ceiling: € 1,537.20 (source: Eurostat (2021) Monthly minimum wages - bi-annual data, 2010-S2)	
	(MISSOC 01/07/2010) */
	
replace ml_ben1 = earning 		if country == "NL" & year == 2010 & gender == 1 /// 
								& ml_eli == 1 & econ_status == 2
							
replace ml_ben1 = 1537.20			if country == "NL" & year == 2010 & gender == 1 /// 
