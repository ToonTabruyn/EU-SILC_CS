...
replace pt_ben1 = 799	 				if country == "IS" & year == 2014 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pt_ben1 < 799
										
replace pt_ben1 = 2677	 				if country == "IS" & year == 2014 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pt_ben1 >= 2677
...
replace pt_ben1 = 1108	 				if country == "IS" & year == 2014 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& pt_ben1 < 1108
...
* the rest 
replace pt_ben1 = 483					if country == "IS" & year == 2014 & pt_eli == 1 ///
