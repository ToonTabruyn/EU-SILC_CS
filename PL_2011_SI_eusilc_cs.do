...
replace pl_ben1 = 0.9*earning 		if country == "SI" & year == 2011 & pl_eli == 1 ///
									& inlist(econ_status,1,2)

replace pl_ben1 = 790.73 			if country == "SI" & year == 2011 & pl_eli == 1 ///
									& inlist(econ_status,1,2) & pl_ben1 < 790.73
									
replace pl_ben1 = 2863	 			if country == "SI" & year == 2011 & pl_eli == 1 ///
