...
/*	-> 90% earning 
	...
	The minimum and maximum values of benefit are sourced from LP&R 2010. 
*/
...
* minimum
replace pt_ben1 = 235.16 + (earning * ((21.7-15)/21.7)) 	if country == "BG" & year == 2010 ///
															& pt_eli == 1 & ((earning * 0.9) * (15/21.7)) < 235.16
 
* maximum 
replace pt_ben1 = 1329.18 + (earning * ((21.7-15)/21.7)) 	if country == "BG" & year == 2010 ///
