...
* IGa
gen pt_ben = 24.64 * 21.7 			if country == "FI" & year == 2016 & gender == 2 ///
									& pt_eli == 1 & (earning*12) < 10562

* IGb
replace pt_ben = earning * 0.7 		if country == "FI" & year == 2016 & gender == 2 ///
									& pt_eli == 1 & pt_ben == . ///
									& inrange((earning*12),10562,37167)

* IGc 
gen pt_bena = (37168/12) * 0.7 		if country == "FI" & year == 2016 & gender == 2 ///
...
replace pt_ben = pt_bena + pt_benc + pt_bend 		if country == "FI" ///
							& year == 2016	& gender == 2 & pt_eli == 1 & pt_ben == . ///
							& (earning*12) > 57183
