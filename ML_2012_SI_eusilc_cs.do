...
replace ml_dur1 = 0 			if country == "SI" & year == 2012 & ml_eli == 1

replace ml_dur2 = 105/7 		if country == "SI" & year == 2012 & ml_eli == 1 ///
								& gender == 1
...
/*	-> 100%
	...
	-> minimum: €323.55/month (LP&R 2012)		*/
	
replace ml_ben1 = earning 		if country == "SI" & year == 2012 & ml_eli == 1 ///
								& inlist(econ_status,1,2)	
replace ml_ben1 = 323.55 		if country == "SI" & year == 2012 & ml_eli == 1 ///
								& inlist(econ_status,1,2) & ml_ben1 < 323.55
replace ml_ben1 = 2863	 		if country == "SI" & year == 2012 & ml_eli == 1 ///
