...
replace pl_ben1 = 986	 				if country == "IS" & year == 2016 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pl_ben1 < 986 & gender == 1
										
replace pl_ben1 = 4138	 				if country == "IS" & year == 2016 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
...
replace pl_ben1 = 1367	 				if country == "IS" & year == 2016 & pl_eli == 1 ///
...
* the rest - women
replace pl_ben1 = 596					if country == "IS" & year == 2016 & pl_eli == 1 ///
