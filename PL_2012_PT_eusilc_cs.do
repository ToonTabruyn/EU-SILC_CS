...
gen pl_init = (150 - (6*5) - 15)/5 		if country == "PT" & year == 2012
...
replace pl_ben1 =  419.22		if country == "PT" & year == 2012 & pl_eli == 1	///
...
replace pl_ben2 = earning 		if country == "PT" & year == 2012 & pl_eli == 1
